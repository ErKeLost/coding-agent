...
const TEXT_BY_NAME: Record<string, string> = {
  ...
  'read-local-process-logs.txt': readFileSync(new URL('./text/read-local-process-logs.txt', import.meta.url), 'utf8'),
  ...
  'write-stdin.txt': readFileSync(new URL('./text/write-stdin.txt', import.meta.url), 'utf8'),
