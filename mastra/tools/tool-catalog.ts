...
export const TOOL_CATALOG: ToolCatalogEntry[] = [
  ...
  { name: 'exec_command', description: 'Start a Codex-style background terminal session.', tags: ['command', 'exec', 'terminal', 'background', 'codex'] },
  { name: 'write_stdin', description: 'Poll or send stdin to a Codex-style background terminal session.', tags: ['command', 'exec', 'terminal', 'stdin', 'background', 'codex'] },
  { name: 'clean_background_terminals', description: 'Stop all live background terminal sessions.', tags: ['command', 'exec', 'terminal', 'background', 'stop', 'codex'] },
