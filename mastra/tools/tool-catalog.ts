...
export const TOOL_CATALOG: ToolCatalogEntry[] = [
  ...
  { name: 'browser_open', description: 'Open a reusable browser session and navigate to a page.', tags: ['browser', 'web', 'session', 'ui'] },
  { name: 'browser_click', description: 'Click an element in an existing browser session.', tags: ['browser', 'click', 'ui'] },
  { name: 'browser_type', description: 'Fill an input in an existing browser session.', tags: ['browser', 'input', 'form', 'ui'] },
  { name: 'browser_wait', description: 'Wait for browser state, text, or elements.', tags: ['browser', 'wait', 'ui'] },
  { name: 'browser_snapshot', description: 'Capture browser text and screenshot state.', tags: ['browser', 'screenshot', 'ui', 'verify'] },
  { name: 'browser_list_sessions', description: 'List active browser sessions.', tags: ['browser', 'session', 'list'] },
  { name: 'browser_close', description: 'Close a browser session.', tags: ['browser', 'session', 'cleanup'] },
