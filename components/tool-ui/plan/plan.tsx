...
export function Plan({
  ...
  return (
    <Card
      className={cn("w-full min-w-0 max-w-none gap-1.5 py-1 text-xs", className)}
      data-tool-ui-id={id}
      data-slot="plan"
    >
        <CardHeader className="px-2.5 pb-0">
          <button
            ...
            className="flex w-full items-center justify-between gap-2 rounded-md px-1 py-0.5 text-left transition-colors hover:bg-muted/40"
            aria-expanded={!isCollapsed}
          >
            <div className="min-w-0">
              <div className="flex items-center gap-1.5">
                <CardTitle className="truncate text-[10px] font-medium leading-4">
                  {title}
                </CardTitle>
                {allComplete ? (
              ...
              <CardDescription className="mt-0.5 text-[10px] leading-4 text-muted-foreground">
        ...
        {!isCollapsed ? (
        <CardContent className="min-w-0 px-2.5 pt-1">
